...
def run_block_a(tickers, benchmark_symbol, start_date, end_date):
    ...
    return data_stocks, data_benchmark, returns_stocks, returns_benchmark, returns_pivot_stocks, portfolio_combinations, portfolio_labels