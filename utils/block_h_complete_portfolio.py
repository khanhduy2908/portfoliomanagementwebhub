...
def run(hrp_result_dict, adj_returns_combinations, cov_matrix_dict,
    ...
    # 2. Get expected returns and covariance matrix
    ...
    # 3. Determine max risk-free ratio from risk_score
    if 10 <= risk_score <= 17:
        max_rf_ratio = 0.40
    ...
    # 4. Optimize utility U = E(rc) - 0.5 * A * σ²
    def neg_utility(y):
    ...
    # 5. Enforce minimum risk-free ratio (risk constraint)
