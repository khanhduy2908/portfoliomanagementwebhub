...
def run(hrp_result_dict, adj_returns_combinations, cov_matrix_dict,
    ...
    # --- 1. Select the best HRP portfolio ---
    ...
    # --- 2. Compute expected return and risk ---
    ...
    # --- 3. Set max_rf_ratio from risk_score ---
    if 10 <= risk_score <= 17:
        max_rf_ratio = 0.40
    ...
    # --- 4. Optimize y to maximize utility ---
    def neg_utility(y):
