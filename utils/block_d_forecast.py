...
def construct_dataset(df_combo, subset, lookback=12):
    X, y = [], []
...
def run_block_d(selected_tickers, selected_combinations, data_stocks):
    lookback = 12
    min_samples = 100
    ...
    for combo in selected_combinations:
        ...
        X_raw, y = construct_dataset(df_combo, subset, lookback=lookback)
