...
def sidebar_config():
    ...
    tickers_input = st.sidebar.text_input("Stock Tickers (comma-separated)", value=",".join(DEFAULT_TICKERS))
    ...
    rf_annual = st.sidebar.number_input("Annual Risk-Free Rate (%)", value=DEFAULT_RF_ANNUAL * 100) / 100
    rf = rf_annual / 12
    ...
    return tickers, benchmark_symbol, start_date, end_date, rf_annual, rf, total_capital, A, run_button